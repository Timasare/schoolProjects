...
% [x1 x2]
nodalPositions = [0 0; 3 0; 6 0; 9 0; 12 0; 3 2; 6 2; 9 2];   % x1- and x2-coordinates of each node

connectivities = [ 1 2 1; 1 6 1; 6 2 1; 2 3 1; 6 3 1; 3 7 1; 6 7 1; 7 8 1; 3 8 1; 3 4 1; 4 8 1; 4 5 1; 5 8 1];    % element 1 [el.node1 el.node2 materialID]
                       % ....
                    % last element
E              = 21e9;
A              = 0.01;
...
mprop          = [E A ];   % material and geometrical properties [E A I]

DirichletBCs   = [1 1 0; 1 2 0; 5 2 0];   % essential boundary conditions [nodeno. dof disp/rot]
F              = 1e3;
P              = -2e3;
NeumannBCs     = [6 1 F; 2 2 P; 3 2 P; 4 2 P];                                         
...
scaleFactor = 300;  % we are working with small strains - you will need scaling for visualisation 
